          ...
          <div className="main-wrapper w-75">
            <Form onSubmit={(e) => this.register(e)}>
              ...
              <Form.Label className="form-label">
                ...
                <a className="terms-tag">LinkedIn User Agreement</a>,{" "}
                <a className="terms-tag">Privacy Policy</a>, and{" "}
                <a className="terms-tag">Cookie Policy</a>.{" "}
              </Form.Label>
            ...
            <Button variant="primary" type="submit" className="google-btn mt-4">
              ...
              <a href={process.env.REACT_APP_URL + "/users/googleLogin"}>
                {" "}
                Log In with Google
              </a>
            </Button>
            <div className=" d-flex justify-content-center mt-4">
              ...
              <a className="blue ml-2" onClick={() => (window.location = "/")}>
                Sign In
              </a>
            </div>
          </div>
