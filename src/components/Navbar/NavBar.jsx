...
const handleLogout=()=>{
  ...
  <Dropdown className="me ">
								...
								>
                 <a onClick={handleLogout} className="pl-2 log-out" style={{fontSize:"12px",color:"black",fontWeight:"bold"}} >Log out </a>
                  </Dropdown.Menu >
